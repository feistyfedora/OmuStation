...
using Content.Shared._Omu.Silicon.AiCameraWarping;
using Content.Shared.SurveillanceCamera;
using Robust.Client.UserInterface;
using Content.Client.SurveillanceCamera;

namespace Content.Client._Omu.AiSurveillanceCamera.UI;

public sealed class AiSurveillanceCameraMonitorBoundUserInterface : BoundUserInterface
{
    ...
    [ViewVariables]
    private AiSurveillanceCameraMonitorWindow? _window;

    [ViewVariables]
    private EntityUid? _currentCamera;

    public AiSurveillanceCameraMonitorBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    ...
    protected override void Open()
    {
        ...
        _window = this.CreateWindow<AiSurveillanceCameraMonitorWindow>();
